...
import { TrendingUp, AlertCircle, CheckCircle, Clock, DollarSign, ArrowUpRight } from 'lucide-react';
                  ...
                  {renewals.map((r) => (
                      <div key={r.id} className="px-6 py-4 flex items-center justify-between hover:bg-slate-800/30 transition-colors">
                          ...
                          <div className="flex items-center gap-4">
                              ...
                              <button className="px-3 py-1 bg-slate-800 text-xs font-medium text-white rounded hover:bg-emerald-600 transition-colors">
                                  Remind
                              </button>
                          </div>
                      </div>
